...
def run2(data_path):
    ...
    _mini_train, _mini_val, mini_y, mini_val_y = train_test_split(mini_train, mini_y, test_size=0.1, random_state=42)
    print("Training size: ", _mini_train.shape, "Training label size:", mini_y.shape, "Testing size:", _mini_val.shape, "Testing label size:", mini_val_y.shape)
    ...
    # run classifier: regression trees:
    print("Fitting....")
    _model = models.regressionTrees(_mini_train, mini_y, _mini_val, mini_val_y)
    del _mini_train
    del mini_y
    del _mini_val
    del mini_val_y
    ...
    # Just as before in training, remove "floor_count" and "year_built":
