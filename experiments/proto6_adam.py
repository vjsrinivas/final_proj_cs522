...
def run1(data_path, lr=0.001, epochs=25, momentum=0.9):
    ...
    _r2 = sk_r2score(test_y, val_preds)
    print("R2 Score:", _r2)
...
def loadTrainData(data_path):
    ...
    _data_cache = 'data_cache_v2.npy'
    _meta_cache = 'meta_cache_v2.npy'
    ...
    if os.path.exists(_data_cache):
        ...
        x,y,meta = data.mapMetaToTrainv2(train_building_data, train_meta_data, train_weather_data)
